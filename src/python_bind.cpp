...
class gpuRIR_bind {
	public:
		...
		py::array getTaus_bind(std::vector<scalar_t>, std::vector<scalar_t>, py::array_t<scalar_t, py::array::c_style>, py::array_t<scalar_t, py::array::c_style>, py::array_t<scalar_t, py::array::c_style>, micPattern, std::vector<int> , scalar_t, scalar_t);
...
py::array gpuRIR_bind::getTaus_bind(std::vector<scalar_t> room_sz, // Size of the room [m]
...
PYBIND11_MODULE(gpuRIR_bind,m)
{
  ...
  py::class_<gpuRIR_bind>(m, "gpuRIR_bind")
        ...
        .def("getTaus_bind", &gpuRIR_bind::getTaus_bind, "Reflection TAUs", py::arg("room_sz"), py::arg("beta"), py::arg("pos_src"), 
			 py::arg("pos_rcv"), py::arg("orV_rcv"), py::arg("mic_pattern"), py::arg("nb_img"), py::arg("Fs"), py::arg("c")=343.0f )
